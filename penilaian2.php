...
$query = mysqli_query($mysqli, "SELECT * from penilaian2");
...
<html lang="en">
  <head>
  	<title>Penilaian Pelatihan</title>
    <meta charset="utf-8">
  ...
  <body>
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li>
            <a href="#"><span class="fa fa-edit mr-3" href="#!"></span> Penilaian Pelatihan</a>
          </li>
          <li>
...
<td><a href="tambah data5.php"class="btn btn-sm btn-info" ><left>Tambah Mitra</a>
<table class="table table-bordered table-responsive" width="180%" >
</td>
    <thead>
        <tr>
    ...
    <?php
        ...
        <tr>
            ...
            <td>
            <a href="hapus data5.php?no=<?php echo $result['no'];?>" class="btn btn-sm btn-danger">Hapus</a>
            <a href="form edit5.php?no=<?php echo $result['no'];?>&&page=edit" class="btn btn-sm btn-warning">Edit</a>
        </td>
        </tr>
        <?php }?>
        </thead>
